...
//send message handle
  ...
  {message.timestamp ? timeAgo(message.timestamp) : "Unknown time"}
</p>  </div>
               </div>
       ...
       <div className=' fixed bottom-4 w-full h-16 '>
              <div className='h-full pr-10 flex gap-4 items-center justify-between rounded-full w-1/2 mx-auto dark:bg-gray-900'>
                    ...
                    }} placeholder='Type your message here...' className='w-full dark:bg-gray-800 dark:border-gray-600 px-5 py-2 rounded-full h-full focus:outline-none' />
